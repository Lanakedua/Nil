...
${chalk.red('By :')} ${chalk.red('Lana')} ${chalk.red('-')} ${chalk.red('Script Dupe Trophy & Crown')}
${chalk.blue('Website : replit.com/@Lana')}
${chalk.blue('Whaatshap : 088245059368')}
${chalk.blue('Discord : Eskey')}
